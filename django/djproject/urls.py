...
urlpatterns = patterns('',
	...
	url(r'^manage_article_write/', 'Kblog.manages.manage_article_write'),
	url(r'^manage_article_edit/', 'Kblog.manages.manage_article_edit'),
	url(r'^manage_article_delete/', 'Kblog.manages.manage_article_delete'),
	...
	url(r'^manage_comment_delete/', 'Kblog.manages.manage_comment_delete'),

	url(r'^manage_category/', 'Kblog.manages.category'),
	url(r'^manage_category_add/', 'Kblog.manages.manage_category_add'),
	...
	url(r'^manage_attachment_delete/', 'Kblog.manages.manage_attachment_delete'),

	url(r'^manage_user/', 'Kblog.manages.user'),
	url(r'^manage_user_add/', 'Kblog.manages.manage_user_add'),
	url(r'^manage_user_edit/', 'Kblog.manages.manage_user_edit'),
	url(r'^manage_user_delete/', 'Kblog.manages.manage_user_delete'),
